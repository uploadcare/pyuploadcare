...
``pyuploadcare`` requires Python 3.10, 3.11, 3.12, 3.13, 3.14

To use ``pyuploadcare`` with Python 3.8 or 3.9 please install ``pyuploadcare < 7.0``.
...
.. csv-table:: Django compatibility
   ...
   :align: center
    ...
    Py/Dj,3.2,4.0,4.1,4.2,5.0,5.1,5.2,6.0
    3.10,X,X,X,X,X,X,X,
    3.11,,,X,X,X,X,X,
    3.12,,,,X,X,X,X,X
    3.13,,,,,,X,X,X
