...
class FileRegexTest(unittest.TestCase):
    def test_value_error_when_uuid_is_bad(self):
        ...
        self.assertRaises(
            InvalidParamError, setattr, file_, "uuid", file_serialized_invalid
        )
        self.assertRaises(
            InvalidParamError,
            setattr,
    ...
    def test_uuid_and_crop_effect(self):
        ...
        expected_cdn_url = (
            "https://ucarecdn.com/cde35b21-c5e1-4ed4-b2fc-d4ef4b0538b0/-/crop/296x445/251,81/"
        )
...
class FileGroupRegexTest(unittest.TestCase):
    ...
    def test_valid_group_id(self):
        ...
        expected_cdn_url = (
            "https://ucarecdn.com/d5f45851-3a58-41a4-b76c-356e22837a2f~12/"
        )
...
class StoreFileGroupTest(unittest.TestCase):
    ...
    def test_successful_store(self, request):
        ...
        request.return_value = MockResponse(
            status=200, data=b'{"datetime_stored": "2013-04-03T12:01:28.714Z"}'
        )
        group.store()
...
class FileGroupCreateTest(unittest.TestCase):
    ...
    def test_invalid_request_error_if_non_file_instance(self):
        files = (File("6c5e9526-b0fe-4739-8975-72e8d5ee6342"), None)
...
class FileListTestCase(unittest.TestCase):
    ...
    def test_starting_point_valid_datetime_uploaded(self):
        ...
        for ordering in (None, "datetime_uploaded", "-datetime_uploaded"):
            ...
            self.assertTrue("from={0}".format(quote(now.isoformat())) in f.api_url())
    ...
    def test_api_url(self):
        f = FileList(
            starting_point="123", ordering="size", request_limit=10, stored=True
        )
        url = f.api_url()
    ...
    def test_count_invalid(self):
        ...
        with self.assertRaisesRegexp(
            ValueError, "Can't count objects if the `starting_point` present"
        ):
            f.count()
